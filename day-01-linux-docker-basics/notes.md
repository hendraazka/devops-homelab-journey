# Day 01 — Linux CLI Basics & Docker Fundamentals

[⬅️ Kembali ke index](../README.md)
...
### 6. Untuk update selanjutnya

```bash
git add .
git commit -m "Day X: <deskripsi progress>"
git push
```

---

[⬅️ Kembali ke index](../README.md) | [Lanjut ke Day 02 ➡️](../day-02-networking-volumes/notes.md)
